...
function Index(props) {
    ...
    if(props.weatherDetails){
        ...
        let weather_details = (wObj.weather.description)[0].toUpperCase() + wObj.weather.description.slice(1);
        ...
        let forecast_jsx = ()=>{
            ...
            return week.map(day=>{
                ...
                return (
                    <div className={styles.forecast_single}>
                ...
                <div className={styles.weather_wrapper}>
                    <div className={styles.weather_basic}>
                        ...
                        <div className={styles.iconTemp_wrapper}>
                            <i className={cx(`wi wi-owm-${wObj.weather.id}`,styles.weather_icon)}/>
